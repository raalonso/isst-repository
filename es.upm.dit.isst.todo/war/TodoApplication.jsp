				...
				<c:when test="${user != null}">
					<form action="/new" method="post" accept-charset="utf-8">
						...
						<table>
							...
							<tr>
								<td valign="top"><label for="deadline">Deadline</label></td>
								<td><input type="text" name="deadline" id="deadline" pattern="\d{2}-\d{2}-\d{4}" title="Task deadline. Format dd-MM-yyyy." /></td>
							</tr>
							<tr>
